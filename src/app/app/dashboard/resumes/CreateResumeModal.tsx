...
export const CreateResumeModal = ({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent hideClose className="max-w-[1100px] w-[calc(100vw-24px)] sm:w-[95vw] h-[80vh] sm:h-[85vh] p-0 overflow-hidden bg-white/95 dark:bg-gray-950/95 backdrop-blur-2xl border-white/20 dark:border-white/10 shadow-2xl rounded-[2rem] flex flex-col">
                ...
                <div className="relative w-full h-full min-h-0 flex flex-col">
                    {/* HEADER BAR */}
                    <div className="flex-none px-4 py-3 md:px-8 md:py-6 flex items-center justify-between z-10">
                        <div className="text-xl md:text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-500 dark:from-white dark:to-gray-400 flex items-center">
                    ...
                    <div className="flex-1 min-h-0 relative w-full">
                        <ScrollArea className="h-full w-full">
                            <div className="px-4 pb-6 md:px-8 md:pb-12 max-w-7xl mx-auto space-y-6 md:space-y-12">
                                {/* SECTION 1: BLANK TEMPLATE */}
                                <section>
                                    <div className="flex items-center mb-3 md:mb-6">
                                        <h4 className="text-sm md:text-xl font-bold text-gray-900 dark:text-white">
                                            {t("dashboard.resumes.createDialog.startFromBlank")}
                                        </h4>
                                        <div className="h-px bg-gray-200 dark:bg-gray-800 flex-1 ml-4 md:ml-6" />
                                    </div>
                                    <motion.div
                                        ...
                                        className="group cursor-pointer rounded-2xl border border-gray-200/60 dark:border-gray-800/60 shadow-sm bg-gray-50/50 dark:bg-gray-900/50 hover:bg-white dark:hover:bg-gray-900 hover:shadow-xl hover:border-primary/50 dark:hover:border-primary/50 transition-all duration-300 p-3 md:p-6 flex flex-col sm:flex-row items-center gap-3 md:gap-6"
                                    >
                                        {/* Small visual icon area */}
                                        <motion.div
                                            layoutId={`card-image-blank`}
                                            className="h-16 w-16 md:h-32 md:w-32 flex-shrink-0 rounded-2xl bg-white dark:bg-gray-800 shadow-inner flex items-center justify-center border border-gray-100 dark:border-gray-700"
                                        >
                                            <FilePlus className="w-7 h-7 md:w-10 md:h-10 text-gray-400 group-hover:text-primary transition-colors" />
                                        </motion.div>

                                        <div className="flex-1 text-center sm:text-left">
                                            <motion.div layoutId={`card-title-blank`} className="inline-block">
                                                <h5 className="text-base md:text-xl font-bold text-gray-900 dark:text-white mb-1 md:mb-2 group-hover:text-primary transition-colors">
                                                    {t("dashboard.resumes.createDialog.blankTitle")}
                                                </h5>
                                            </motion.div>
                                            <p className="text-gray-500 dark:text-gray-400 text-xs md:text-sm max-w-lg leading-relaxed">
                                ...
                                <section>
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6 sm:gap-8 hover:!shadow-none">
                                        {NORMAL_TEMPLATES.map((template) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <span className="text-xs md:text-[15px] font-semibold text-gray-700 dark:text-gray-200 group-hover:text-primary transition-colors">
                                                            {templateName}
                                                        </span>
                                                    </motion.div>
                                                </motion.div>
