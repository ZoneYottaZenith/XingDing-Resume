  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent
        ...
        className="w-[calc(100vw-32px)] max-w-md rounded-[32px] border-none dark:bg-neutral-900 bg-white p-0 shadow-xl"
      >
          ...
          <div className="relative flex flex-col items-center">
            ...
            <AlertDialogHeader>
              <AlertDialogTitle className="text-center text-base md:text-xl font-bold text-gray-900 dark:text-neutral-200">
                {content.title}
              </AlertDialogTitle>
            ...
            <AlertDialogFooter className="mt-4 md:mt-8 flex w-full gap-3 md:gap-4 sm:flex-row">
              <AlertDialogCancel className="flex-1 rounded-full dark:bg-gray-800 dark:text-neutral-200 text-sm md:text-base font-semibold text-gray-800 ">
                {t("cancelText")}
              </AlertDialogCancel>
              <AlertDialogAction
                onClick={onConfirm}
                ...
                className="group relative flex-1 overflow-hidden rounded-full bg-primary px-6 py-2 md:py-3 text-sm md:text-base font-semibold text-white hover:bg-primary"
              >
