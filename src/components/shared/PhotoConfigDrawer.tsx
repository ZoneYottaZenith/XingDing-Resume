    ...
    >
      ...
      >
        <div className="mx-auto w-full max-w-md overflow-y-auto">
          <DrawerHeader className="pb-1 md:pb-4">
            <DrawerTitle className="text-center text-sm md:text-base">{t("title")}</DrawerTitle>
          ...
          <div className="px-4 py-2 space-y-1 md:p-6 md:space-y-6">
            <span className="text-xs md:text-sm">{t("upload.dragHint")}</span>
            <span className="ml-2 text-xs text-neutral-500 mt-1">
              ({t("upload.sizeLimit")})
            </span>
          </div>
          <div className="px-4 pb-3 space-y-4 md:p-6 md:space-y-6">
            <div className="space-y-2 md:space-y-3">
              <h3 className="text-xs font-medium md:text-sm">{t("upload.title")}</h3>
              <Textarea
                value={imageUrl}
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="space-y-2 md:space-y-3">
                <h3 className="text-xs font-medium md:text-sm">{t("config.size")}</h3>
          ...
          <DrawerFooter className="pb-[calc(1rem+env(safe-area-inset-bottom,0px))] md:pb-4">
