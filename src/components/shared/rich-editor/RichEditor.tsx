  ...
  return (
    <div className="relative" onClick={(e) => e.stopPropagation()}>
      <Button
        ...
        size="sm"
        className={cn(
          "h-7 w-7 md:h-9 md:w-9 rounded-md transition-all duration-200 hover:scale-105 p-0",
          isActive
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="h-7 w-7 md:h-9 md:w-9 p-0 rounded-md hover:scale-105 transition-all duration-200 hover:bg-primary/5 relative group"
        >
          <PaintBucket
            className="h-5 w-5"
            style={{
          ...
          <div className="grid grid-cols-6 gap-1">
            ...
            {colors.map((color: ColorOption) => (
              <button
                ...
                className={`h-8 w-8 rounded-md border hover:scale-110 transition-transform relative
                  ${
                    ...
                    color.value === "transparent"
                      ? " bg-muted/30 text-xs font-medium text-muted-foreground"
                      : ""
                  }`}
                style={
                  color.value === "transparent"
                ...
                title={color.label}
              >
                {color.value === "transparent" ? "透" : null}
              </button>
            ))}
          </div>
        </div>
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          size="sm"
          className={cn(
            "h-7 w-7 md:h-9 md:w-9 p-0 rounded-md transition-all duration-200 hover:scale-105",
...
const RichTextEditor = ({
  ...
  const editorProps = useMemo(
    () => ({
      attributes: {
        class: cn(
          "tiptap max-w-none focus:outline-none min-h-[150px] px-3 py-2 md:px-4 md:py-3 text-sm md:text-base",
  ...
  return (
    ...
    >
      <div
        className={cn(
          "border-b px-2 py-1 md:py-1.5 flex flex-wrap items-center gap-1.5 md:gap-3 [&_svg]:h-3.5 [&_svg]:w-3.5 md:[&_svg]:h-5 md:[&_svg]:w-5",
        ...
        <div className="flex items-center space-x-1">
          ...
          {onPolish && (
            <Button
              ...
              className="h-6 md:h-8 px-2 md:px-3 text-[10px] md:text-xs gap-1 ml-1 border-primary/20 hover:border-primary/40 text-primary hover:bg-primary/5 transition-all duration-300 group"
            >
