      ...
      >
        <DialogHeader className="pb-3 md:pb-6">
          ...
          >
            <Sparkles
              className={cn(
                "h-4 w-4 md:h-6 md:w-6 text-primary animate-pulse",
          ...
          <div className="space-y-2">
            ...
            <div
              className={cn(
                ...
                "bg-neutral-50 dark:bg-neutral-800/50",
                "border-neutral-200 dark:border-neutral-800",
                "p-3 md:p-6 h-[140px] md:h-[400px] overflow-auto shadow-sm"
              )}
            >
              <Streamdown
                className={cn(
          ...
          <div className="space-y-2">
            ...
            <div
              ...
              className={cn(
                ...
                "p-3 md:p-6 h-[140px] md:h-[400px] overflow-auto shadow-sm scroll-smooth"
              )}
            >
              <Streamdown
                animated
        ...
        <DialogFooter className="mt-3 md:mt-6 flex flex-row items-center gap-3">
          <Button
            onClick={handlePolish}
            disabled={isPolishing}
            className="flex-1 bg-gradient-to-r from-[#9333EA] to-[#EC4899] hover:opacity-90 text-white border-none h-9 md:h-11 shadow-lg shadow-purple-500/20 text-xs md:text-sm"
          >
            {isPolishing ? (
          ...
          <Button
            ...
            className="flex-1 bg-primary hover:bg-primary/90 text-white h-9 md:h-11 shadow-lg shadow-primary/20 text-xs md:text-sm"
          >
            {t("button.apply")}
          </Button>
        </DialogFooter>
