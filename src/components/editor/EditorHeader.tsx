...
import { AlertCircle, ShieldCheck, ShieldAlert, ArrowLeft, Maximize2 } from "lucide-react";
...
export function EditorHeader({ isMobile }: EditorHeaderProps) {
  ...
  return (
    <motion.header
      className={`h-12 md:h-16 border-b sticky top-0 z-10`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    >
      <div className="flex items-center justify-between px-3 md:px-6 h-full pr-2">
