  ...
  return (
    ...
    >
      <div className="p-3 md:p-4">
        <motion.div
          className={cn(
            "mb-3 p-3 md:mb-4 md:p-4 rounded-lg border",
          ...
          <div className="flex items-center gap-2">
            ...
            {activeSection === "basic" ? (
              ...
              <>
                <input
                  className={cn(
                    "flex-1 text-sm md:text-lg font-medium text-primary border-black bg-transparent outline-none pb-1 text-primary"
                  )}
                  type="text"
                  value={
                    menuSections?.find((s) => s.id === activeSection)?.title
