  ...
  return (
    ...
    >
      <motion.div
        {...itemAnimations}
        className={cn(
          "grid grid-cols-[auto,auto,1fr,1fr,auto,auto] gap-1.5 md:gap-3 items-center p-2 md:p-3",
          "bg-card rounded-xl",
    ...
    return (
      ...
      >
        <motion.div
          {...itemAnimations}
          className={cn(
            "flex items-center gap-2 p-2 pr-2 md:gap-4 md:p-4 md:pr-3",
            "bg-card",
            "rounded-lg ",
            "transition-all duration-200",
        ...
        >
          ...
          <div className="flex flex-1 min-w-0 items-center">
            ...
            <div className="w-[56px] ml-[2px] text-xs md:w-[80px] md:ml-[4px] md:text-sm font-medium text-foreground">
    ...
    <div className="space-y-3 p-3 md:space-y-6 md:p-6">
      <div className="space-y-3 md:space-y-6">
        <div className="space-y-2">
          <h2 className="text-sm md:text-lg font-medium">{t("layout")}</h2>
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm md:text-lg font-medium">{t("title")}</h2>
          </div>
            ...
            <motion.div className="space-y-3 md:space-y-6">
              ...
              <motion.div className="space-y-3 md:space-y-6">
                <motion.div className="space-y-3">
                  <motion.h3 className="font-medium text-xs md:text-base text-neutral-900 dark:text-neutral-200 px-1">
                    {t("basicField")}
                  </motion.h3>
                ...
                <motion.div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="mt-2 md:mt-4">
                      <div className="flex items-center ml-2 md:ml-3 space-x-2">
                        <div className="w-[76px] text-xs md:w-[110px] md:text-sm">Access Token</div>
                        <Input
                          placeholder="请输入github access token"
                          className="flex-1 h-8 text-xs md:h-10 md:text-sm"
                      ...
                      <div className="flex items-center ml-2 md:ml-3 mt-2 md:mt-4 space-x-2">
                        <div className="w-[76px] text-xs md:w-[110px] md:text-sm">UseName</div>
                        <Input
                          className="flex-1 h-8 text-xs md:h-10 md:text-sm"
