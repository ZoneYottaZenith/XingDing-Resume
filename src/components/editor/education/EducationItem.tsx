  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "w-8 md:w-12 flex items-center justify-center border-r shrink-0 touch-none",
      ...
      <div className="flex-1 min-w-0">
        <div
          className={cn(
            "px-3 py-2 md:px-4 md:py-4 flex items-center justify-between",
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3">
              <div>
                <h3
                  className={cn(
                    "font-medium truncate text-sm md:text-base leading-tight",
                    "text-foreground"
                  )}
                >
                ...
                {(education.major || education.degree) && (
                  <p
                    className={cn(
                      "text-xs md:text-sm truncate leading-tight",
        ...
        <AnimatePresence>
          {expandedId === education.id && (
            ...
            >
              <div
                className={cn(
                  "px-3 pb-3 md:px-4 md:pb-4 space-y-3 md:space-y-4",
                  "border-border"
                )}
