...
export default function FeaturesSection() {
  ...
  return (
    <section className="py-12 md:py-40 bg-background overflow-hidden">
      <div className="container mx-auto px-6 max-w-6xl">
        <AnimatedFeature>
          <div className="text-center mb-10 md:mb-32">
            <h2 className="text-2xl md:text-5xl font-serif font-semibold tracking-tight text-foreground/90 mb-4 md:mb-6">
              {t("features.title")}
            </h2>
            <div className="w-20 h-1 bg-primary/20 mx-auto rounded-full mb-5 md:mb-8" />
            <p className="text-sm md:text-xl text-muted-foreground/80 max-w-2xl mx-auto font-light leading-relaxed">
              {t("features.subtitle")}
            </p>
          </div>
        </AnimatedFeature>
        ...
        <div className="space-y-16 md:space-y-40">
          {features.map((category, catIndex) => (
            <div 
              key={catIndex} 
              className={`flex flex-col gap-8 lg:gap-24 items-center ${
            ...
            >
              ...
              <div className="w-full lg:w-5/12 space-y-6 md:space-y-10">
                <AnimatedFeature delay={0.1}>
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <h3 className="text-xl md:text-4xl font-serif font-medium tracking-tight text-foreground/90">
                      {t(category.title)}
                    </h3>
                    <p className="text-sm md:text-lg text-muted-foreground/90 leading-relaxed font-light">
              ...
              <div className="w-full lg:w-7/12">
                <AnimatedFeature key={`${catIndex}-${activeFeatures[catIndex]}`} delay={0.2}>
                  <div className="relative aspect-[16/10] bg-secondary/20 rounded-3xl border border-border/50 p-3 sm:p-10 shadow-2xl backdrop-blur-sm group overflow-hidden">
